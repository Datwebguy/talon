          ...
          return (
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {stock.status === "Active Vault" ? (
                    ...
                    <span className="px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-[11px] font-bold border border-gray-200 dark:border-gray-700">
                      Coming Soon
                    </span>
                  ) : (
                ...
                <div className="mt-4 pt-4 border-t border-[#E2E8F4] dark:border-[#1E294B] space-y-2">
                  <div className="text-[10px] font-semibold text-[#94A3B8] dark:text-[#64748B]">
                    Split Claims
                  </div>
              ...
              <div className="pt-2 flex items-center gap-2">
                ...
                >
                  <span>{stock.status === "Active Vault" ? "Open Vault" : "Open Split Desk"}</span>
