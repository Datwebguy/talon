...
export default function DashboardPage() {
  ...
  const supportedAssets = [
    ...
    },
    {
      ...
      price: marketData?.MSTR?.formattedPrice || "—",
      change: marketData?.MSTR?.formattedChange || "—",
      isPositive: true,
      status: "Verified DEX",
      isLive: true,
    },
    {
      ...
      name: "SanDisk Corp.",
      Logo: SanDiskLogo,
      price: marketData?.SNDK?.formattedPrice || "—",
      change: marketData?.SNDK?.formattedChange || "—",
      isPositive: true,
      status: "Verified DEX",
      isLive: true,
    },
    {
      ...
      name: "SpaceX",
      Logo: SpaceXLogo,
      price: marketData?.SPCX?.formattedPrice || "—",
      change: marketData?.SPCX?.formattedChange || "—",
      isPositive: true,
      status: "Verified DEX",
      isLive: true,
    },
